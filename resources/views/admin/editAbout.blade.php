...
@section('main')
    ...
    <section class="section">
                        ...
                        <form action="{{ route('about.update', ['about' => $about->id]) }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <!-- Use $about->name as the default value -->
                                    @error('name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="describe" name="describe" class="form-control"
                                           ...
                                           value="{{ old('describe', $about->describe) }}">
                                    <!-- Keep old value after error -->
                                    @error('describe')
                                    <span class="text-danger">{{ $message }}</span> <!-- Show error message -->
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="job_title" name="job_title" class="form-control"
                                           value="{{ old('job_title', $about->job_title) }}">
                                    @error('job_title')
                                    <span class="text-danger">{{ $message }}</span> <!-- Show error message -->
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="freelance" name="freelance"
                                               value="1"
                                            {{ old('freelance', $about->freelance) ? 'checked' : '' }}>
                                        <!-- Keep old value after error -->
                                    </div>
                                </div>
                            </div>
        ...
        <textarea id="description" name="description" class="form-control" maxlength="600"
                  rows="4">{{ old('description', $about->description) }}</textarea> <!-- Keep old value after error -->
                                    @error('description')
                                    <span class="text-danger">{{ $message }}</span> <!-- Show error message -->
                                    @enderror
                                </div>
